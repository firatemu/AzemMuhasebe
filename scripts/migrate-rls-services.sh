...
SERVICE_DIR="/home/azem/projects/muhasebe/api-stage/server/src/modules"
...
if [ $UPDATED_FILES -eq 0 ]; then
    ...
    echo "     cd /home/azem/projects/muhasebe/api-stage && docker build -f server/Dockerfile.staging.prod -t muhasebe-backend:latest ."
    echo ""
    echo "  2. Container restart:"
    echo "     cd /home/azem/projects/muhasebe && docker restart muhasebe-backend-staging"
    echo ""
    echo "  3. Test:"
