...
export class EmailService {
  ...
  async sendWelcomeEmail(
    ...
    const subject = 'Hoş Geldiniz - Muhasebe';
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #191970; color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
        <h1 style="margin: 0; font-size: 28px;">Muhasebe</h1>
    </div>
    ...
    <div style="background-color: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #ddd; border-top: none;">
        ...
        <p>Muhasebe ailesine katıldığınız için teşekkür ederiz. Hesabınız başarıyla oluşturuldu.</p>
        ...
        <p>Artık Muhasebe sistemini kullanmaya başlayabilirsiniz. Sistemimiz ile:</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="${process.env.FRONTEND_URL || 'https://panel.muhasebe.com'}" 
        ...
        <p style="color: #666; font-size: 14px; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 20px;">
            ...
            <strong>E-posta:</strong> <a href="mailto:mail@muhasebe.com">mail@muhasebe.com</a>
        </p>
...
Muhasebe ailesine katıldığınız için teşekkür ederiz. Hesabınız başarıyla oluşturuldu.

E-posta Adresiniz: ${to}
İsim: ${fullName}

Artık Muhasebe sistemini kullanmaya başlayabilirsiniz. Sistemimiz ile:
...
Sisteme giriş yapmak için: ${process.env.FRONTEND_URL || 'https://panel.muhasebe.com'}

Herhangi bir sorunuz veya öneriniz için bizimle iletişime geçebilirsiniz.
E-posta: mail@muhasebe.com
...
Bu otomatik bir e-postadır. Lütfen bu e-postaya yanıt vermeyiniz.
    ...
    try {
      const mailOptions = {
        from: process.env.SMTP_FROM || 'Muhasebe <mail@muhasebe.com>',
  ...
  async sendInvitationEmail(
    ...
    const subject = `${tenantName} - Muhasebe Daveti`;
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #ddd; border-top: none;">
        ...
        <p><strong>${tenantName}</strong> sizi Muhasebe sistemine davet etti.</p>
...
${tenantName} sizi Muhasebe sistemine davet etti.
...
Bu otomatik bir e-postadır. Lütfen bu e-postaya yanıt vermeyiniz.
  ...
  async sendMaturityReminderEmail(
    ...
    const subject = 'Vade Hatırlatması - Muhasebe';
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 650px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f9f9f9; padding: 25px; border-radius: 0 0 10px 10px; border: 1px solid #ddd; border-top: none;">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="${process.env.FRONTEND_URL || 'https://panel.muhasebe.com'}/cek-senet" 
        ...
        <p style="color: #666; font-size: 13px; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 15px;">
            ...
            <strong>Destek:</strong> mail@muhasebe.com
        </p>
    </div>
</body>
</html>
