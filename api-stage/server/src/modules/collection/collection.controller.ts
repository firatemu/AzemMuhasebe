...
export class CollectionController {
  ...
  @Post()
  @RequirePermissions({ module: 'collection', action: 'create' })
  ...
  @Get()
  @RequirePermissions({ module: 'collection', action: 'list' })
  ...
  @Get(':id')
  @RequirePermissions({ module: 'collection', action: 'view' })
  findOne(@Param('id') id: string) {
    return this.collectionService.findOne(id);
  }

  @Delete(':id')
  @RequirePermissions({ module: 'collection', action: 'delete' })
