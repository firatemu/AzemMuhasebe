...
import { formatDiscountPercent } from '@/lib/print-formatters';
    ...
    try {
      ...
      const mappedFatura: Fatura = {
        ...
        kalemler: (data.items || data.kalemler || []).map((item: any) => ({
          ...
          iskontoOran: Number(item.discountRate ?? item.iskontoOran ?? 0),
    ...
    >
      ...
      <TableContainer sx={{
        ...
        <Table size="small" sx={{
          ...
          minWidth: { xs: '680px', sm: 'auto' },
        }}>
          <TableHead>
            <TableRow sx={{ bgcolor: '#191970' }}>
              <TableCell sx={{ color: 'white', fontWeight: 'bold', width: '12%' }}>Ürün Kodu</TableCell>
              <TableCell sx={{ color: 'white', fontWeight: 'bold', width: '32%' }}>Ürün Adı</TableCell>
              <TableCell align="center" sx={{ color: 'white', fontWeight: 'bold', width: '8%' }}>Miktar</TableCell>
              <TableCell align="right" sx={{ color: 'white', fontWeight: 'bold', width: '11%' }}>Birim Fiyat</TableCell>
              <TableCell align="center" sx={{ color: 'white', fontWeight: 'bold', width: '9%' }}>Malzeme İnd. %</TableCell>
              <TableCell align="center" sx={{ color: 'white', fontWeight: 'bold', width: '6%' }}>KDV %</TableCell>
              <TableCell align="right" sx={{ color: 'white', fontWeight: 'bold', width: '12%' }}>Toplam</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {fatura.kalemler.map((kalem, index) => (
              <TableRow key={kalem.id} sx={{ '&:nth-of-type(even)': { bgcolor: '#f8f9fa' } }}>
                ...
                <TableCell align="center">{formatDiscountPercent(kalem.iskontoOran)}</TableCell>
          ...
          <Table size="small" sx={{
            ...
            <TableHead>
              <TableRow sx={{ borderBottom: '2px solid #667eea' }}>
                <TableCell sx={{ fontWeight: 'bold', color: '#667eea', width: '46%' }}>ÜRÜN</TableCell>
                <TableCell align="center" sx={{ fontWeight: 'bold', color: '#667eea', width: '8%' }}>ADET</TableCell>
                <TableCell align="right" sx={{ fontWeight: 'bold', color: '#667eea', width: '12%' }}>FİYAT</TableCell>
                <TableCell align="center" sx={{ fontWeight: 'bold', color: '#667eea', width: '10%' }}>MALZ. İND. %</TableCell>
                <TableCell align="right" sx={{ fontWeight: 'bold', color: '#667eea', width: '12%' }}>TOPLAM</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {fatura.kalemler.map((kalem, index) => (
                <TableRow key={kalem.id} sx={{ borderBottom: '1px solid #f0f0f0' }}>
                  ...
                  <TableCell align="center">
                    <Typography variant="body2">{formatDiscountPercent(kalem.iskontoOran)}</Typography>
                  </TableCell>
                  <TableCell align="right">
