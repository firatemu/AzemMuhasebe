...
const nextConfig: NextConfig = {
  ...
  // TypeScript hatalarını build sırasında görmezden gel (staging için)
  typescript: {
  ...
  serverExternalPackages: ["@prisma/client", "bcrypt", "exceljs", "pdfmake"],
  ...
  // Turbopack config (Next.js 16 default) – monorepo kökünü yanlış algılamasın
  turbopack: {
    root: process.cwd(),
  },
    ...
    if (dev) {
      ...
      if (!isServer) {
        const watchPolling =
          ...
          process.env.CHOKIDAR_USE_POLLING === "true";
